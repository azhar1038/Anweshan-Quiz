          ...
          child: ScrollConfiguration(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                Color background;
                if(index == 0) background = Color(0xffffd700);
                else if(index == 1) background = Color(0xffc0c0c0);
                else if(index == 2) background = Color(0xffc49c48);
                else background = Colors.transparent;
